...
(let* ((bg "#111318")
      ...
      (primary-fixed-dim "#2b4678")
      (secondary-fixed "#bfc6dc")
      (secondary-fixed-dim "#3f4759")
      (tertiary-fixed "#debcdf")
      (tertiary-fixed-dim "#583e5b")
      (on-primary-fixed "#102f60")
      (on-primary-fixed-variant "#d8e2ff")
      (on-secondary-fixed "#293041")
      (on-secondary-fixed-variant "#dbe2f9")
      (on-tertiary-fixed "#402843")
      (on-tertiary-fixed-variant "#fbd7fc")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e2e9")
      (inverse-primary "#adc6ff")
      (inverse-surface "#111318")
